    ...
    >
      ...
      <defs>
        <radialGradient
          ...
          fx="98.304%"
          fy="99.82%"
          gradientTransform="matrix(.3623 0 0 1 .627 0)"
        >
          <stop offset=".709%" stopColor="#FFF" />
          <stop offset="3.01%" stopColor="#CBFFFF" />
          <stop offset="5.701%" stopColor="#96FFFF" />
          <stop offset="8.428%" stopColor="#68FFFF" />
          <stop offset="11.13%" stopColor="#43FFFF" />
          <stop offset="13.82%" stopColor="#25FFFF" />
          <stop offset="16.47%" stopColor="#1FF" />
          <stop offset="19.08%" stopColor="#04FFFF" />
          <stop offset="21.59%" stopColor="#0FF" />
          <stop offset="100%" stopColor="#00F" stopOpacity={0} />
        </radialGradient>
        <radialGradient id="a" cx="50%" cy="50%" r="47.621%" fx="50%" fy="50%">
          <stop offset="0%" stopColor="#0861A7" />
          <stop offset="100%" stopColor="#0961A2" stopOpacity={0} />
        </radialGradient>
        <radialGradient
          id="b"
          cx="50%"
          ...
          fy="50.5%"
        >
          <stop offset="0%" stopColor="#268FBA" />
          <stop offset="100%" stopColor="#0961A2" stopOpacity={0} />
        </radialGradient>
        <radialGradient id="c" cx="50%" cy="50%" r="37.796%" fx="50%" fy="50%">
          <stop offset="0%" stopColor="#FFF" />
          <stop offset="28.935%" stopColor="#EDF7FF" />
        ...
        <mask id="e">
          <path
            ...
            stroke="#fff"
            strokeWidth={30}
            d="M945.31 284.637C887.681 126.14 731.334 12.5 547.5 12.5c-154.748 0-290.019 80.524-363.324 200.546"
            className="mask-arc"
          />
        </mask>
        <g id="d">
      ...
      <g className="disney" transform="translate(171 93)">
        <use
          xlinkHref="#d"
          className="plus-glow"
          transform="translate(855 274)"
        />
        <path
          fill="#FFF"
        ...
        />
        <g className="sparks" transform="translate(855 274)">
          <use xlinkHref="#d" className="spark" />
          <use xlinkHref="#d" className="spark" />
          <use xlinkHref="#d" className="spark" />
          <use xlinkHref="#d" className="spark" />
          <use xlinkHref="#d" className="spark" />
        ...
        <path
          fill="#FFF"
          d="M1040.9 378.6v13.2c0 2.9-2.3 5.2-5.2 5.2h-62.9c0 3.3.1 6.2.1 8.9 0 19.5-.8 35.4-2.7 53.3-.3 2.7-2.5 4.7-5.1 4.7h-13.6c-1.4 0-2.7-.6-3.6-1.6-.9-1-1.4-2.4-1.2-3.8 1.9-17.8 2.8-33.5 2.8-52.6 0-2.8 0-5.7-.1-8.9h-62.2c-2.9 0-5.2-2.3-5.2-5.2v-13.2c0-2.9 2.3-5.2 5.2-5.2h61.3c-1.3-21.5-3.9-42.2-8.1-63.2-.2-1.3.1-2.6.9-3.6s2-1.6 3.3-1.6h14.7c2.3 0 4.2 1.6 4.7 3.9 4.1 21.7 6.7 42.8 8 64.5h63.7c2.8 0 5.2 2.4 5.2 5.2Z"
          className="plus"
        />
        <path
          fill="url(#f)"
          d="M955.3 273.9c-32.5-79.9-87.4-148-158.8-197C723.4 26.8 637.7.3 548.7.3 401.5.3 264.9 73.4 183.4 195.9c-.9 1.3-1.1 3-.6 4.5.5 1.6 1.7 2.7 3.2 3.2l11.4 3.9c.7.2 1.4.3 2 .3 2.1 0 4.1-1.1 5.3-2.8 37.4-55 88-100.7 146.4-132.3 60.3-32.6 128.6-49.9 197.5-49.9 83.3 0 163.6 24.6 232.4 71 67.1 45.3 119.2 108.6 150.7 182.9.9 2.2 3.1 3.7 5.5 3.7h13.6c1.6 0 3.1-.8 3.9-2.1 1-1.3 1.2-2.9.6-4.4Z"
          className="arc"
          mask="url(#e)"
        />
        <use xlinkHref="#d" className="glow" transform="translate(835 164)" />
        <path
          fill="none"
          d="M945.31 284.637C887.681 126.14 731.334 12.5 547.5 12.5c-154.748 0-290.019 80.524-363.324 200.546"
          className="glow-path"
